...
class GoogleSheets:
    ...
    def get_all_values(self):
        ...
        return self.sheet.get_all_values()   # esto devuelve una lista de diccionarios, por lo que la clave es la columna de nombre y el valor es el valor de esa columna en particular
